...
class Atri:
	def __init__(self, state: Any):
		...
		self.TextBox253 = self.__TextBox253Class(state["TextBox253"], default_state["TextBox253"])
	...
	class __TextBox253ClassstylesClass:
		def __init__(self, state, def_state):
			...
			self.outlineWidth: str = get_defined_value(state, def_state, "outlineWidth")
			self.cursor: str = get_defined_value(state, def_state, "cursor")
	class __TextBox253ClasscustomClass:
		def __init__(self, state, def_state):

			self.text: str = get_defined_value(state, def_state, "text")
	class __TextBox253Class:
		def __init__(self, state, def_state):
			self.onClick = False
			self.styles: Atri.__TextBox253ClassstylesClass = Atri._Atri__TextBox253ClassstylesClass(get_defined_value(state, def_state, "styles"), def_state["styles"])
			self.custom: Atri.__TextBox253ClasscustomClass = Atri._Atri__TextBox253ClasscustomClass(get_defined_value(state, def_state, "custom"), def_state["custom"])
